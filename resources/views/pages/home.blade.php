                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-7">
                        <div class="present">
                            ...
                            <div class="section_btn">
                                <a href="https://t.me/Match_Ease_bot" target="_blank"> <button class="btn btn-default" type="submit"> Get
                    ...
                    <div class="col-md-5">
                        <div class="present_img">
                            <img src="images/START-removebg-preview.png" alt="image">
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                        ...
                        <div class="features_detail">
                            <ul>
                                <li>
                                    ...
                                    <p>Open Telegram and search for our bot or click the button below. Begin by typing
                                        <code>/start</code>.
                                    </p>
                                </li>
                                <li>
                                    ...
                                    <p>Answer a few questions about yourself and your preferences. All data is kept private
                                        and secure.</p>
                                </li>
                                ...
                                <li>
                                    ...
                                    <p>Use <code>/profile</code> anytime to view your details.</p>
                                </li>
                                ...
                                <li>
                                    ...
                                    <p>Type <code>/matches</code> to see profiles that match your preferences.</p>
                                ...
                                <li>
                                    ...
                                    <p>Want to make changes? Just use <code>/update_profile</code>.</p>
                                </li>

                                <li class="mb-4">
                                    <i class="fa fa-check-circle" aria-hidden="true"></i>
                                    <h5>6. View Approved Profiles</h5>
                                    <p>Use <code>/approved</code> to see profiles you've shown interest in.</p>
                                </li>

                                <li class="mb-4">
                                    <i class="fa fa-clock" aria-hidden="true"></i>
                                    <h5>7. View Pending Profiles</h5>
                                    <p>Use <code>/pending</code> to check pending connection requests or matches.</p>
                                </li>

                                <li>
                                    <i class="fa fa-trash" aria-hidden="true"></i>
                                    <h5>8. Delete Your Profile</h5>
                                    <p>Type <code>/delete_profile</code> if you wish to remove your profile from the
                                        platform.</p>
                                </li>
                    ...
                    <div class="col-md-6">
                        <div class="features_img pull-left">
                            <img src="images/Untitled_design__16_-removebg-preview.png" alt="image">
                        </div>
                        <div class="features_img pull-left">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section_heading section_heading_2">
                        ...
                        <div class="section_btn">
                            <span> <a href="https://t.me/Match_Ease_bot" target="_blank"> <button class="btn btn-default" type="submit">Get
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section_heading section_heading_2">
                        ...
                        {{-- <h4>Let drop a line to us & we will be in touch soon. Here goes some simple dummy text. Lorem Ipsum
