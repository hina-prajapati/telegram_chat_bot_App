...
//         $answers['job_status'] = $text;

//         $this->saveAnswer($chatId, $state, 'job_status', $text, Profile::class);

//         return [
//             'text' => __('messages.thanks_job_status', ['status' => $text]),
...
//     {
//         return __('messages.ask_job_status');
//     }
        ...
        return [
            ...
            'reply_markup' => json_encode([
                'keyboard' => [
                    ...
                    [['text' => __('messages.job_prefer_not')]],
                    [['text' => __('messages.job_service')]],
                ],
